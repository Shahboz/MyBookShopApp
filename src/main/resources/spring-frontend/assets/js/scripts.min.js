                                ...
                                getData('/search/page/' + $this.data('refreshquery'), {
                                    offset: function () {
                                        ...
                                        if(oldOffset < 1){
                                            ...
                                            $this.data('refreshoffset', oldOffset + $this.data('refreshlimit'));    // For Google Api
                                        }else{
                                            //$this.data('refreshoffset', ++oldOffset - $this.data('refreshlimit'));
                                            $this.data('refreshoffset', oldOffset);                                 // For Google Api
                                        }
                    ...
                    $('.Transactions-get').on('click', function (e) {
                        ...
                        getData('/transactions', {
                            ...
                            offset: function () {
                                ...
                                var limit = $this.data('transactionlimit');
                                $this.data('transactionoffset', oldOffset+limit);
