                                ...
                                $.ajax({
                                    ...
                                    complete: function (result) {
                                        if (result.status === 200) {
                                            ...
                                            $Cards.prepend(data);
                                            var $BtnPrimary = $Cards.find('.btn_primary');
                                            if (result.responseJSON.count < $this.data('searchlimit')) {
                                                $BtnPrimary.hide();
                                            } else {
                                                $BtnPrimary.show();
                                                $BtnPrimary.data('refreshoffset', $this.data('searchlimit'));
                                            }
                                        } else {
        ...
        var Card = function () {
            var bookTemplate = function (book) {
                return'<div class="Card">' +
                       ...
                       '     <a href="' + book.slug + '">' + '       <img src="' + book.image + '">\n' + '</a>' +
                    ...
                    '                <strong class="Card-title"><a href="' + book.slug + '">' + book.title + '</a>\n' + '</strong>\n' +
                    '                <div class="Card-description">' + book.getAuthorName() + '</div>\n' +
                    '                <div class="Card-cost">' +
                                ...
                                complete: function (result) {
                                    if (result.status === 200) {
                                        ...
                                        if (result.responseJSON.count < $this.data('refreshlimit')) {
                                            $('.Cards-footer_center').hide();
                                        } else {
                                            $('.Cards-footer_center').show();
                                        }
                            ...
                            postData('/approveContact', data, function (result) {
                                if (result.result) {
                                    ...
                                    if (result != null && result.return) {
                                        ...
                                        $row.find('.form-input_code').addClass('form-input_error').after('<div class="form-error">' + result.error + '</div>');
                                    } else {
                                ...
                                postData('/login-by-phone-number', $this.data('send'), function (result) {
                                    if (result != null && result.result) {
                                        ...
                                        if (result != null && result.return) {
                                            ...
                                            $thisStep.find('.form-input:not(.form-input_hide)[type="text"]').addClass('form-input_error').after('<div class="form-error">' + (result != null ? result.error : 'Пользователь не найден или неверный логин/пароль!') + '</div>');
                                        }
                                    }
                                })
                            }
            ...
            return {
                init: function () {
                    ...
                    $('input[name="mail"], input[name="phone"]').on('change', function () {
                        ...
                        $row.next('.Profile-btn_confirm').show(0);
                    });

                    $('#submitChangePhone').on('click', function() {
                        var $this = $(this), $row = $this.closest('.form-group'),
                            data = {contact: $row.find('.form-input_phone').val()};
                        Login().postData('/requestContactConfirmation', data, function (result) {
                            if (result.result) {
                                $this.after('<div class="form-info">Вам направлен код подтверждения по SMS</div>');
                                $this.attr('disabled', 'disabled');
                                $row.find('.form-input_code').attr('type', 'text');
                                $row.find('.form-input_code').attr('data-validate', 'require key');
                                $row.addClass('form-group_confirm');
                                $row.find('.form-error').remove();
                            } else {
                                $this.addClass('form-input_error').after('<div class="form-error">' + result.error + '</div>');
                    ...
                    $('input[name="phoneCode"], input[name="mailCode"]').on('blur', function () {
                        var $this = $(this), $form = $this.closest('.form-group'),
                            $row = $this.closest('.form-group_row'), data = {
                            contact: $row.find('.form-input_phone, .form-input_mail').val(),
                            code: $row.find('.form-input_code').val()
                        }, $but = $form.find('.Profile-btn_confirm');
                        if (!$but.hasClass('form-input_error')) {
                            Login().postData('/approveContact', data, function (result) {
                                if (result.result) {
                                    $this.attr('disabled', 'disabled');
                                    $but.attr('disabled', 'disabled');
                                    $row.after('<div class="form-info">Код успешно подтвержден</div>');

                                } else {
                                    if (result != null && result.return) {
                                        $form.removeClass('form-group_confirm');
                                        $this.val('');
                                        $but.prop('disabled', false);
                                        $row.find('.form-input_code').addClass('form-input_error').after('<div class="form-error">' + result.error + '</div>');
                                    } else {
                                    ...
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        function sendData(address) {
                                            getData(address, {
                                                offset: function () {
                                                    ...
                                                    var limit = $(slick.$slider).data('loadlimit');
                                                    $(slick.$slider).data('loadoffset', oldOffset+limit);
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            ...
                                            case'popular':
                                                ...
                                                break;
                                            case'authorBook':
                                                sendData('/books/author/' + $(slick.$slider).data('refreshid'));
                                                break;
                                        }
                                    }
                                }
                        ...
                        if (sum != null && sum > 0) {
                            Login().postData('/payment', {
                                ...
                                if (result.result) {
                                    ...
                                    $('.Topup-wrap').append('<div class="form-group">' + '<div class="form-error">' + result.error + '</div>' + '</div>')
                                }
                            })
                        }
                    });
                ...
                $.ajax({
                    ...
                    complete: function (result) {
                        if (result.status === 200) {
                            ...
                            var $BtnPrimary = $('.Transactions').find('.btn_primary');
                            $BtnPrimary.data('transactionoffset', $BtnPrimary.data('transactionoffset') + $BtnPrimary.data('transactionlimit'));
                            if (result.responseJSON.count < $BtnPrimary.data('transactionlimit')) {
                                $BtnPrimary.hide();
                            } else {
                                $BtnPrimary.show();
                            }
